...
<body>
                ...
                <tbody>
                    <?php foreach ($result as $row): ?>
                        <tr>
                            ...
                            <td>
                                <div class="botao" onclick="excluirUsuario(<?= $row['id']; ?>)">
                                </div>
                            </td>
    ...
    <script>
        function excluirUsuario() {
            if(confirm*"Tem certeza que deseja excluir o usuário " + nome_completo + "?") {
                $.ajax({
                    type: "POST",
                    url: "controller.php ? controller = UsuarioController & method=excluir_usuario"
                })
            }
